    ...
    <body>
        ...
        <main>
            ...
            <div class="contact_form" style = "text-align: center;">
                <form method="post" enctype="text/plain" name="contact_form">
                    ...
                    <fieldset style="width: fit-content; margin: auto;" id="description_textarea">
                        ...
                        <textarea placeholder="Description for project here!" rows="10" cols="30" id="description" name = "description">
                        </textarea>
                    </fieldset><br>
